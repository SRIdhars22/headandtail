            ...
            <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-50 border border-zinc-200 rounded-lg px-4 py-2.5 text-zinc-900 placeholder-zinc-400 focus:outline-none focus:bg-white focus:border-accent-purple focus:ring-1 focus:ring-accent-purple transition-all text-sm"
                  value={formData.name}
              ...
              {type === 'demo' ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      min={tomorrowDate}
                      className="w-full bg-zinc-50 border border-zinc-200 rounded-lg px-4 py-2.5 text-zinc-900 focus:outline-none focus:bg-white focus:border-accent-teal focus:ring-1 focus:ring-accent-teal transition-all text-sm"
                      value={formData.date}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-zinc-50 border border-zinc-200 rounded-lg px-4 py-2.5 text-zinc-900 placeholder-zinc-400 focus:outline-none focus:bg-white focus:border-accent-purple focus:ring-1 focus:ring-accent-purple transition-all text-sm resize-none"
              ...
              <button
                type="submit"
                className={`w-full py-3 rounded-lg font-semibold text-sm transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] ${
                  type === 'consultation'
